...
class SettingsApp {
  ...
  _exportSettings() {
    ...
    a.href = url;
    a.download = `vantage-security-settings-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
  ...
  _exportWhitelist() {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `vantage-security-whitelist-${new Date().toISOString().slice(0, 10)}.txt`;
    a.click();
    URL.revokeObjectURL(url);
  ...
  _exportSiteBlacklist() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a');
    a.href = url; a.download = 'vantage-security-site-blacklist.txt';
        ...
        <div class="about-content">
          ...
          <div class="about-card">
            ...
            <div class="about-links">
              <a class="about-link" href="https://asystech.cn/vantage" target="_blank" rel="noopener">
              ...
              <a class="about-link" href="https://asystech.cn/vantage/issues/new/choose" target="_blank" rel="noopener">
              ...
              <a class="about-link" href="https://asystech.cn/vantage/releases" target="_blank" rel="noopener">
